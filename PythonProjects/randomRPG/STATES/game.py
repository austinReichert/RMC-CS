...
class Game(State):
    ...
    def statWindow(self, window, baseX, baseY, character):
        ...
        _displayText(window, (baseX + 100), (baseY+5), Color.BLACK, "Level: {}".format(character.level), self.fonts['tiny'])
        _popOutText(window, (baseX + 10), (baseY + 25), Color.RED, Color.BLUE, "HP:", self.fonts['base'])
        _displayText(window, (baseX + 95), (baseY + 30), Color.PURPLE, "{}/{}".format(character.currentHP, character.maxHP), self.fonts['tiny'])
