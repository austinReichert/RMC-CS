...
public class Graph {
    ...
    public void traverseBreadthFirst(int start, GraphVisitor visitor){
        traverseBreadthFirst(start, visitor, new GraphVisitor.SearchContext(directed));
    }
    private void traverseBreadthFirst(int startingVertex, GraphVisitor visitor, GraphVisitor.SearchContext context) {
        ...
        while(!traversalQueue.isEmpty()){
            ...
            ArrayList<EdgeNode> p = edges.getOrDefault(vertex, new ArrayList<>());
                //this was Collections.emptyList()
